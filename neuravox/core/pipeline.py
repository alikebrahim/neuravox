...
from modules.shared.metadata import ProcessingMetadata, MetadataManager
from modules.shared.file_utils import ensure_directory, create_file_id
...
class AudioPipeline:
    ...
    def cleanup_workspace(self, keep_transcribed: bool = True):
        ...
        from modules.shared.file_utils import cleanup_empty_directories
